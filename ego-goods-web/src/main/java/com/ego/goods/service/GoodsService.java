...
public class GoodsService {
    ...
    public Map<String, Object> loadModel(Long spuId) {
        ...
        //查询分类列表
        List<Category> categoryList = this.categoryClient.queryListByIds(ids).getBody();

        //查询品牌信息
        Brand brand = this.brandClient.queryListByIds(Collections.singletonList(spuBo.getBrandId())).getBody().get(0);
    ...
    public void buildStaticHtml(Long spuId, Map<String, Object> map) {
        ...
        executorService.submit(()-> {
                ...
                try {
                    FileWriter writer = new FileWriter("D:\\ide\\nginx-1.15.9\\html\\item\\" + spuId + ".html");
